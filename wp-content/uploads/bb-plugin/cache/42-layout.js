...
var wpAjaxUrl='http://www.transconelectronics.com/wp-admin/admin-ajax.php';var flBuilderUrl='http://www.transconelectronics.com/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://www.transconelectronics.com/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://www.transconelectronics.com/wp-admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);function initMap(map,position,zoom){map.setCenter(position);map.setZoom(zoom);var marker=new google.maps.Marker({position:position,map:map});}var position={lat:22.5678704,lng:88.34622880000006};initMap(new google.maps.Map(document.getElementById('map-module-57dd88441cede'),{scrollwheel:false}),position,12);