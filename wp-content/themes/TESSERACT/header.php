...
<meta name="google-site-verification" content="sklIbdR8LscidGJo3nGvgLCk-rnXPJNtlVwt8zqL73o" />

<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-111924689-14"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-111924689-14');
</script>
