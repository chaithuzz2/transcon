...
function UPCP_Add_WC_Cart_HTML() {
	...
	$ReturnString .= '<input type="submit" name="Submit_Inquiry" value="Checkout!"/>';
	$ReturnString .= '</form>';
	$ReturnString .= '</a>';
