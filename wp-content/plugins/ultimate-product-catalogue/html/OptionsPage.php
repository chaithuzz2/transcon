...
<table id='premium-options' class="form-table upcp-options-table">
	...
	<div onMouseOver="ShowToolTip('product_inquiry_cart_exp')" onMouseOut="HideToolTip('product_inquiry_cart_exp')" class="questionMark"><br>
	<div id="product_inquiry_cart_exp" class="toolTip" ><?php _e("Should users be able to inquire about multiple products at once from the main catalog page (requires plugin 'Contact Form 7')?", 'UPCP')?></div></div>
	</th>
	<td>
	...
	<div onMouseOver="ShowToolTip('woocommerce_sync_exp')" onMouseOut="HideToolTip('woocommerce_sync_exp')" class="questionMark"><br>
	<div id="woocommerce_sync_exp" class="toolTip" ><?php _e("Should UPCP products be exported to WooCommerce, and WooCommerce products imported into UPCP? Products edited in one plugin will also be edited in the other while this is enabled.", 'UPCP')?></div></div>
	</th>
	<td>
		...
		<label title='Yes'><input type='radio' name='woocommerce_sync' value='Yes' <?php if($WooCommerce_Sync == "Yes") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?>/> <span><?php _e("Yes", 'UPCP')?><?php _e(" (requires plugin 'WooCommerce')", 'UPCP')?></span></label><br />
	...
	<div onMouseOver="ShowToolTip('woocommerce_checkout_exp')" onMouseOut="HideToolTip('woocommerce_checkout_exp')" class="questionMark"><br>
	<div id="woocommerce_checkout_exp" class="toolTip" ><?php _e("Should checkout be allowed, using the standard WooCommerce checkout? WARNING: WooCommerce sync must be enabled.", 'UPCP')?></div></div>
	</th>
	<td>
	...
	<div onMouseOver="ShowToolTip('hidden_drop_down_sidebar_on_mobile_exp')" onMouseOut="HideToolTip('hidden_drop_down_sidebar_on_mobile_exp')" class="questionMark"><br>
	<div id="hidden_drop_down_sidebar_on_mobile_exp" class="toolTip" ><?php _e("Will make so that, on mobile devices, the sidebar is hidden by default. A 'Filter' button will display allowing the user to open the sidebar.", 'UPCP')?></div></div>
	</th>
	<td>
	...
	<div onMouseOver="ShowToolTip('infinite_scroll_exp')" onMouseOut="HideToolTip('infinite_scroll_exp')" class="questionMark"><br>
	<div id="infinite_scroll_exp" class="toolTip" ><?php _e("Should products load as a user scrolls down the page, instead of using the pagination system?", 'UPCP')?></div></div>
	</th>
	<td>
