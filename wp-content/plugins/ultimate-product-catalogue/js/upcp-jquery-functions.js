...
function adjustCatalogueHeight() {
	...
	jQuery('.prod-cat.thumb-display').each(function() {listOuterHeight += jQuery(this).outerHeight();});
	jQuery('.prod-cat.thumb-display').each(function() {detailOuterHeight += jQuery(this).outerHeight();});
